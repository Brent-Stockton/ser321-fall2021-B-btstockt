...
public class Client {
     ...
     */
    public static JSONObject pop(int key) {
        String strToSend = null;
        JSONObject request = new JSONObject();
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            do {
                ...
                System.out.println("2. remove <int> - removes an element at the given index and shows that element");
                System.out.println("3. display - display the list");
                System.out.println("4. count - returns the elements in the list");
                System.out.println("5. reverse <int> - reverses the String at the given index and displays the new list");
                ...
                switch (choice) {
                    ...
                    case (5):
                       ...
                       // request = StringList.reverse(keychoice);
                        break;
                    case (0):
                        request = quit();
                        break;
